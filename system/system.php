...
class System {
    ...
    private function setParams() {
        ...
        $i = 0;
        if (!empty($this->_explode[2]) && !empty($this->_explode[3])) {
    ...
    public function run() {
        ...
        if (!file_exists($controller_path)) {
            $controller_path = CONTROLLERS . 'erroController.php';
            $this->_controller = "erro";
