...
require_once($_SERVER['DOCUMENT_ROOT'].'/new2/system/config.php'); // temporario (new2), se for publicação final ou local tira o /new2/
require_once($_SERVER['DOCUMENT_ROOT'].'/new2/system/setup.php');
